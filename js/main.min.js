...
function nextNote(a){resultNote="C";isCorrectNote(a)&&(a=NOTES.indexOf(a),a++,a==NOTES.length&&(a=0),resultNote=NOTES[a]);return resultNote}function prevHalfStep(a){a--;a<MIN_HALF_STEP&&(a=MIN_HALF_STEP);return a}function nextHalfStep(a){a++;a>MAX_HALF_STEP&&(a=MAX_HALF_STEP);return a}
...
function sliderLogVal(a,b,d){var c=0;0<a&&(b=Math.log(b),c=Math.exp(b+(Math.log(d)-b)/100*(a-0)));return c};var audioCtx,worker,isMetronomeCanWork=!0;try{audioCtx=new AudioContext}catch(a){console.log(WEB_AUDIO_INIT_ERR_MSG),isMetronomeCanWork=!1}try{worker=new Worker("js/worker.js")}catch(a){console.log(WORKER_INIT_ERR_MSG),isMetronomeCanWork=!1}
...
isCorrectTuningNotes(a.stringsTunes)&&(defaultScaleItemOptions.stringsTunes=a.stringsTunes);void 0!==a.stringsNumber&&isCorrectStringsNumber(a.stringsNumber)&&(defaultScaleItemOptions.stringsNumber=+a.stringsNumber)}}
function ScalesItem(a){this.id=a;this.scale="major";this.root="C";this.semiTones=DEFAULT_SCALE_SEMITONES;this.scaleNotes=DEFAULT_SCALE_NOTES;this.tuning="standart_e";this.halfStep=0;this.stringsNumber=3;this.stringsTunes=DEFAULT_STRING_TUNES;this.putNotesOnString=function(a){var b=this.getTuneForString(a),c=$("."+HOR_FRET_CLASS+":eq("+a+")",$("."+NULL_VER_FRET_CLASS+", ."+VER_FRET_CLASS,this.$fretboardBlock),this.$fretboardBlock);a=getSemiTonesPatternForString(this.scaleNotes,this.semiTones,b);c=
$("."+NOTE_CLASS,c);$(c).css("display","none");for(var e=a.shift(),f=0;f<e;f++)b=nextNote(b);for(var g=0,f=e;f<c.length;){$(c[f]).css("display","inline");$(c[f]).text(b);b==this.root?$(c[f]).toggleClass(NORMAL_NOTE_CLASS,!1).toggleClass(HIGHLIGHTED_NOTE_CLASS,!0):$(c[f]).toggleClass(NORMAL_NOTE_CLASS,!0).toggleClass(HIGHLIGHTED_NOTE_CLASS,!1);f+=a[g%a.length];for(e=0;e<a[g];e++)b=nextNote(b);g=++g%a.length}};this.putNotesOnAllStrings=function(){for(var a=0;a<this.stringsNumber;a++)this.putNotesOnString(a)};
this.incStringsNumber=function(){this.stringsNumber++;this.$stringsNumberBlock.text(""+this.stringsNumber)};this.decStringsNumber=function(){this.stringsNumber--;this.$stringsNumberBlock.text(""+this.stringsNumber)};this.getTuneForString=function(a){return this.stringsTunes[a%this.stringsTunes.length]};this.addString=function(a){var b=this.getTuneForString(a),c=$("."+STRINGS_OPTIONS_BLOCK_CLASS,this.$itemBlock).append(STRING_TUNE_BLOCK_TMPL()).children().last();$("."+STRING_TUNE_SELECT_CLASS+" :contains('"+
b+"')",c).prop("selected",!0);for(var b={currentStringNumber:a+1},e=$("."+NULL_VER_FRET_CLASS+", ."+VER_FRET_CLASS,this.$fretboardBlock),f,g,h=0;h<e.length;h++)$(e[h]).append(STRING_FRET_TMPL(b)),0==a&&(g=h%12,f=3==g||5==g||7==g||10==g,g=0!=h&&0==g,f?$(e[h]).append(STRING_FRET_MARK_TMPL()):g&&$(e[h]).append(STRING_DOUBLE_FRET_MARK_TMPL()));this.putNotesOnString(a);$("."+STRING_TUNE_SELECT_CLASS,c).change({itemThis:this},this.onStringTuneChange);$("."+LEFT_ARROW_CLASS,c).click({itemThis:this},this.onLeftArrowTuneClick);
$("."+RIGHT_ARROW_CLASS,c).click({itemThis:this},this.onRightArrowTuneClick)};this.delLastString=function(){$("."+STRING_TUNE_BLOCK_CLASS,this.$itemBlock).last().remove();for(var a=$("."+NULL_VER_FRET_CLASS+", ."+VER_FRET_CLASS,this.$fretboardBlock),d=0;d<a.length;d++)$("."+HOR_FRET_CLASS,$(a[d])).last().remove()};this.selectCurrentStringsTunes=function(){for(var a=$("."+STRINGS_OPTIONS_BLOCK_CLASS,this.$itemBlock),d=0;d<this.stringsNumber;d++)a.find("."+STRING_TUNE_SELECT_CLASS+":eq("+d+") :contains('"+
this.getTuneForString(d)+"')").prop("selected",!0)};this.selectCurrentTuning=function(){this.$itemBlock.find("."+TUNING_SELECT_CLASS+" [value='"+this.tuning+"']").prop("selected",!0)};this.selectCurrentScale=function(){$("."+SCALE_SELECT_CLASS+" [value='"+this.scale+"']",this.$itemBlock).prop("selected",!0)};this.selectCurrentHalfStep=function(){$("."+HALF_STEP_SELECT_CLASS+" [value='"+this.halfStep+"']",this.$itemBlock).prop("selected",!0)};this.moveTuning=function(a,d){for(var b=1;b<=a;b++)for(var e=
0;e<this.stringsTunes.length;e++)this.stringsTunes[e]=d?nextNote(this.stringsTunes[e]):prevNote(this.stringsTunes[e])};this.changeScaleNotesBlock=function(){$("."+SCALE_NOTES_CLASS,this.$itemBlock).remove();var a=this.scaleNotes;a.push(this.root);a={root:this.root,semiTones:this.semiTones,notes:a};$("."+SCALE_NOTES_BLOCK_CLASS,this.$itemBlock).append(SCALE_NOTES_TMPL(a))};this.onScaleChange=function(a){a=a.data.itemThis;var b=$(this).val().toLowerCase();isCorrectScale(b)&&(a.scale=b,a.semiTones=getScaleSemitones(b),
a.scaleNotes=getNotesFromSemiTones(a.root,a.semiTones),a.putNotesOnAllStrings(),a.changeScaleNotesBlock())};this.onStringTuneChange=function(a){var b=a.data.itemThis,c=$("."+STRINGS_OPTIONS_BLOCK_CLASS,a.data.itemThis.$itemBlock);a=$(this).val();c=$("."+STRING_TUNE_SELECT_CLASS,c).index(this);b.stringsTunes[c]=a;b.putNotesOnString(c);b.tuning=CUSTOM_TUNING_VALUE;b.selectCurrentTuning()};this.onLeftArrowTuneClick=function(a){var b=a.data.itemThis;a=$("."+STRINGS_OPTIONS_BLOCK_CLASS,a.data.itemThis.$itemBlock);
var c=$("."+LEFT_ARROW_CLASS,a).index(this),e=b.stringsTunes[c],e=prevNote(e);b.stringsTunes[c]=e;$("."+STRING_TUNE_SELECT_CLASS+":eq("+c+") :contains('"+e+"')",a).prop("selected",!0);b.putNotesOnString(c);b.tuning=CUSTOM_TUNING_VALUE;b.selectCurrentTuning()};this.onRightArrowTuneClick=function(a){var b=a.data.itemThis;a=$("."+STRINGS_OPTIONS_BLOCK_CLASS,a.data.itemThis.$itemBlock);var c=$("."+RIGHT_ARROW_CLASS,a).index(this),e=b.stringsTunes[c],e=nextNote(e);b.stringsTunes[c]=e;$("."+STRING_TUNE_SELECT_CLASS+
":eq("+c+") :contains('"+e+"')",a).prop("selected",!0);b.putNotesOnString(c);b.tuning=CUSTOM_TUNING_VALUE;b.selectCurrentTuning()};this.onTuningChange=function(a){a=a.data.itemThis;var b=$(this).val().toLowerCase();b==CUSTOM_TUNING_VALUE?a.tuning=b:isCorrectTuning(b)&&(a.tuning=b,a.stringsTunes=getTuneNotes(b),a.moveTuning(Math.abs(a.halfStep),0<a.halfStep),a.putNotesOnAllStrings(),a.selectCurrentStringsTunes())};this.onHalfStepChange=function(a){a=a.data.itemThis;var b=a.halfStep,c=$(this).val().replace(/[^-0-9]/gim,
""),c=+c;a.halfStep=c;a.moveTuning(Math.abs(c-b),c>b);a.selectCurrentStringsTunes();a.putNotesOnAllStrings()};this.onLeftArrowHalfStepClick=function(a){a=a.data.itemThis;var b=a.halfStep;b!=-MAX_HALF_STEP&&(b=prevHalfStep(b),a.halfStep=b,a.moveTuning(1,!1),a.selectCurrentStringsTunes(),a.putNotesOnAllStrings(),a.selectCurrentHalfStep())};this.onRightArrowHalfStepCLick=function(a){a=a.data.itemThis;var b=a.halfStep;b!=MAX_HALF_STEP&&(b=nextHalfStep(b),a.halfStep=b,a.moveTuning(1,!0),a.selectCurrentStringsTunes(),
a.putNotesOnAllStrings(),a.selectCurrentHalfStep())};this.onRootNoteChange=function(a){a=a.data.itemThis;var b=$(this).text();isCorrectNote(b)&&(a.root=b.toUpperCase(),$(" ."+ROOT_NOTE_CLASS+"."+SELECTED_TEXT_CLASS,a.$itemBlock).toggleClass(SELECTED_TEXT_CLASS,!1),$(this).toggleClass(SELECTED_TEXT_CLASS,!0),a.scaleNotes=getNotesFromSemiTones(a.root,a.semiTones),a.changeScaleNotesBlock(),a.putNotesOnAllStrings())};this.onAddStringButton=function(a){a=a.data.itemThis;var b=a.stringsNumber;b<MAX_STRINGS_NUMBER&&
(a.addString(b),a.incStringsNumber())};this.onDelStringButton=function(a){a=a.data.itemThis;a.stringsNumber>MIN_STRINGS_NUMBER&&(a.delLastString(),a.decStringsNumber())};this.onCloseButton=function(a){a=a.data.itemThis;a.$itemBlock.hide(200,function(){$(this).remove()});deleteItem(a.id)};this.onSetDefaultButton=function(a){a=a.data.itemThis;defaultScaleItemOptions.scale=a.scale;defaultScaleItemOptions.root=a.root;defaultScaleItemOptions.semiTones=a.semiTones;defaultScaleItemOptions.tuning=a.tuning;
defaultScaleItemOptions.halfStep=a.halfStep;defaultScaleItemOptions.stringsTunes=a.stringsTunes;defaultScaleItemOptions.stringsNumber=a.stringsNumber;Cookies.set("defaultScaleOptions",defaultScaleItemOptions,{expires:DEFAULT_SCALE_OPTIONS_EXPIRE_DAYS})};this.initStrings=function(){for(var a=0;a<FRETS_NUMBER;a++)this.$fretboardBlock.children().last().before(STRING_VER_FRET_TMPL());for(a=0;a<this.stringsNumber;a++)this.addString(a),this.$stringsNumberBlock.text(""+this.stringsNumber);this.selectCurrentStringsTunes()};
this.readDefaultScaleItemOptions=function(){this.scale=defaultScaleItemOptions.scale;this.root=defaultScaleItemOptions.root;this.semiTones=getScaleSemitones(this.scale);this.scaleNotes=getNotesFromSemiTones(this.root,this.semiTones);this.tuning=defaultScaleItemOptions.tuning;this.halfStep=defaultScaleItemOptions.halfStep;this.stringsTunes=defaultScaleItemOptions.stringsTunes;var a=defaultScaleItemOptions.stringsNumber;a<MIN_STRINGS_NUMBER&&(a=MIN_STRINGS_NUMBER);this.stringsNumber=a};this.initAnimation=
function(){this.$itemBlock.hide(0);this.$itemBlock.show(200)};this.init=function(){$addNewItemBtn.before(SCALES_ITEM_BLOCK_TMPL({id:this.id}));this.$itemBlock=$("#"+this.id);this.$stringsNumberBlock=$("."+STRING_NUMBER_CLASS,this.$itemBlock);this.$fretboardBlock=$("."+FRETBOARD_CLASS,this.$itemBlock);this.initAnimation();this.readDefaultScaleItemOptions();this.initStrings();this.changeScaleNotesBlock();this.selectCurrentTuning();this.selectCurrentScale();this.selectCurrentHalfStep();this.putNotesOnAllStrings();
$("."+SCALE_SELECT_CLASS,this.$itemBlock).change({itemThis:this},this.onScaleChange);$("."+TUNING_SELECT_CLASS,this.$itemBlock).change({itemThis:this},this.onTuningChange);$("."+HALF_STEP_SELECT_CLASS,this.$itemBlock).change({itemThis:this},this.onHalfStepChange);this.$itemBlock.find("."+HALF_STEP_BLOCK_CLASS).find("."+LEFT_ARROW_CLASS).click({itemThis:this},this.onLeftArrowHalfStepClick);this.$itemBlock.find("."+HALF_STEP_BLOCK_CLASS).find("."+RIGHT_ARROW_CLASS).click({itemThis:this},this.onRightArrowHalfStepCLick);
